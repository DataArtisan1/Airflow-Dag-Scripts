...
with DAG(
    ...
    description='Advanced File Sensor Pattern Example',
    schedule_interval=None,
    catchup=False,
    tags=['example', 'sensor', 'files']
) as dag:

    # Task 1: Wait for CSV files
